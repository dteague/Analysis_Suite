...
signal = ['tttj_lo', 'tttw_lo', 'tttj_nlo', 'tttw_nlo', 'ttt_nlo', 'ttt_lo', 'tttj_m', 'tttj_p', 'tttw_m', 'tttw_p']
# Ignoring ttZ because of rate parameter
bkg_nottz = ['xg', 'ttw', 'tth', 'ttXY', 'rare', '4top', 'rare_nowz', 'wz']
bkg = ['xg', 'ttw', 'tth', 'ttXY', 'rare', '4top', 'rare_nowz', 'wz', 'ttz']
mc_samples = bkg + signal
mc_nottz = bkg_nottz + signal
...
systematics = [
    Systematic("LUMI_RUN2", "lnN", True).add(1.006, groups=mc_nottz, year="2016pre") \
                                        .add(1.006, groups=mc_nottz, year="2016post") \
                                        .add(1.009, groups=mc_nottz, year="2017")    \
                                        .add(1.020, groups=mc_nottz, year="2018"),
    Systematic("LUMI_17_18", "lnN", True).add(1.006, groups=mc_nottz, year="2017") \
                                         .add(1.002, groups=mc_nottz, year="2018"),
    Systematic("LUMI_", "lnN").add(1.010, groups=mc_nottz, year="2016pre") \
                              .add(1.010, groups=mc_nottz, year="2016post") \
                              .add(1.020, groups=mc_nottz, year="2017")    \
                              .add(1.015, groups=mc_nottz, year="2018"),
    ...
    Systematic("Lepton_tthMVA_SS", "lnN", corr=True).add(1.04, groups=mc_nottz, chan='Dilepton') # 1.02**2 \
                                                    .add(1.061, groups=mc_nottz, chan=['Multi', 'ttzCR', 'ttttCR']), # 1.02**3
    Systematic("Trigger_SS", 'lnN').add(1.05, groups=mc_nottz),
    ...
    ## Fake Rate stuff
    Systematic("ChargeMisId_Stat").add(groups='charge_flip', chan=["Dilepton", 'ttttCR']),
    Systematic("ChargeMisId_Closure", 'lnN').add(1.2, groups="charge_flip", chan=["Dilepton", 'ttttCR']),
    ...
    # Normalization stuff
    Systematic("XSEC_TTTT", "lnN", corr=True).add(1.12, groups="4top"),
    ...
    Systematic("XSEC_TTH", "lnN", corr=True).add(1.08, groups="tth"),
    Systematic("XSEC_XG", "lnN", corr=True).add(1.2, groups="xg"),
    Systematic("XSEC_RARE", "lnN", corr=True).add(1.2, groups="rare"),
